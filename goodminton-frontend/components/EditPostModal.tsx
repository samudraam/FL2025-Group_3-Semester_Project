...
/**
 * Modal component for editing an existing community post
 */
export default function EditPostModal({ visible, onClose, onPostUpdated, post }: EditPostModalProps) {
  ...
  /**
   * Initialize form fields with post data when modal opens
   */
  useEffect(() => {
    if (visible && post) {
      setTitle(post.title || '');
  ...
  const handleSubmit = async () => {
    ...
    try {
      await postsAPI.editPost(post._id, {
        title: trimmedTitle,
